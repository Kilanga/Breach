...
export const WAVE_CONFIGS = [
  ...
  // ── Minute 2–3 ────────────────────────────────────────────────────────────
  {
    ...
    groups: [
      ...
      { type: ENEMY_TYPES.SPEEDSTER, count: 1, spawnInterval: 6.0 },
    ],
  },
  // ── Minute 3–4 ────────────────────────────────────────────────────────────
  {
    ...
    groups: [
      ...
      { type: ENEMY_TYPES.SPEEDSTER, count: 1, spawnInterval: 4.5 },
      { type: ENEMY_TYPES.SHAMAN,    count: 1, spawnInterval: 10.0 },
    ],
  },
  // ── Minute 4–5 ────────────────────────────────────────────────────────────
  {
    ...
    groups: [
      ...
      { type: ENEMY_TYPES.TANK,      count: 1, spawnInterval: 9.0 },
      { type: ENEMY_TYPES.FANTOME,   count: 1, spawnInterval: 7.0 },
    ],
  },
  // ── Minute 5–6 ────────────────────────────────────────────────────────────
  {
    ...
    groups: [
      ...
      { type: ENEMY_TYPES.SNIPER,    count: 1, spawnInterval: 8.0 },
      { type: ENEMY_TYPES.PORTEUR,   count: 1, spawnInterval: 12.0 },
      { type: ENEMY_TYPES.MIMIQUE,   count: 1, spawnInterval: 10.0 },
    ],
  },
  // ── Minute 6–7 ────────────────────────────────────────────────────────────
  {
    ...
    groups: [
      ...
      { type: ENEMY_TYPES.TANK,      count: 1, spawnInterval: 7.0 },
      { type: ENEMY_TYPES.SHAMAN,    count: 1, spawnInterval: 8.0 },
      { type: ENEMY_TYPES.SNIPER,    count: 1, spawnInterval: 6.0 },
      { type: ENEMY_TYPES.FANTOME,   count: 2, spawnInterval: 5.0 },
    ],
  },
  // ── Minute 7+ : chaos total ───────────────────────────────────────────────
  {
    ...
    groups: [
      ...
      { type: ENEMY_TYPES.SPEEDSTER, count: 2, spawnInterval: 2.5 },
      { type: ENEMY_TYPES.TANK,      count: 2, spawnInterval: 5.0 },
      { type: ENEMY_TYPES.SNIPER,    count: 2, spawnInterval: 4.5 },
      { type: ENEMY_TYPES.MIMIQUE,   count: 1, spawnInterval: 8.0 },
      { type: ENEMY_TYPES.PORTEUR,   count: 1, spawnInterval: 9.0 },
      { type: ENEMY_TYPES.FANTOME,   count: 2, spawnInterval: 4.0 },
      { type: ENEMY_TYPES.SHAMAN,    count: 2, spawnInterval: 6.0 },
    ],
  },
];
