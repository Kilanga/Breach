  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: PALETTE.bg }}>
      <ScrollView contentContainerStyle={{ alignItems: 'center', justifyContent: 'center', padding: 20, paddingBottom: 40 }}>
        <Card style={{ width: '100%', maxWidth: 400, alignItems: 'center', borderColor: '#FFCC44', padding: 24 }}>

          <Title style={{ fontSize: 38, color: '#FFCC44', marginBottom: 4 }}>🏆 {t('victory_title') || 'VICTOIRE !'}</Title>
          <Body style={{ fontSize: 13, color: PALETTE.textDim, marginBottom: 20 }}>
            {t('victory_sub') || 'Tu as survécu au Breach !'}
          </Body>
          ...
          <View style={{ width: '100%', gap: 6, marginBottom: 16, paddingTop: 10, borderTopWidth: 1, borderColor: PALETTE.border }}>
            ...
            <StatRow label="🎖 Victoires"        value={meta.totalWins  || 0} />
          </View>

          {/* Fragments gagnés */}
          <View style={{ backgroundColor: 'rgba(255,204,68,0.08)', borderRadius: 10, padding: 12, width: '100%', marginBottom: 18, borderWidth: 1, borderColor: '#FFCC4440' }}>
            <Body style={{ fontSize: 13, color: '#FFCC44', fontWeight: 'bold', marginBottom: 2 }}>
              ⬆ +{talentPointsEarned} points de talent gagnés
            </Body>
            <Body style={{ fontSize: 11, color: PALETTE.textDim }}>
              {fragmentsEarned} fragments · Investis-les dans l'Arbre des Talents !
            </Body>
          </View>

          <Button label={t('victory_replay') || '🔄 Rejouer'} primary onPress={goToShapeSelect} style={{ marginBottom: 10, width: '100%' }} />
