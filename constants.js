...
export const ENEMY_INFO = {
  ...
  // --- Ennemis spéciaux ---
  mimique: {
    name: 'Mimique', short: 'MIM', color: '#CC88FF',
    baseHp: 40, baseDamage: 8, baseSpeed: 1.5, radius: 14,
    xpValue: 18, scoreValue: 36,
    behavior: 'chase',
    special: { mimic: true }, // copie l'upgrade active du joueur (boost temporaire)
    desc: 'Copie un upgrade actif du joueur pendant 5s.',
  },
  porteur: {
    name: 'Porteur', short: 'PRT', color: '#FFAA44',
    baseHp: 55, baseDamage: 5, baseSpeed: 1.1, radius: 17,
    xpValue: 22, scoreValue: 44,
    behavior: 'chase',
    special: { dropRelic: true }, // garantit un drop de relique à sa mort
    desc: 'Garantit un drop de relique à sa mort.',
  },
  fantome: {
    name: 'Fantôme', short: 'FAN', color: '#AADDFF',
    baseHp: 28, baseDamage: 10, baseSpeed: 1.8, radius: 12,
    xpValue: 14, scoreValue: 28,
    behavior: 'chase',
    special: { phaseImmune: true, phaseTimer: 2.0 }, // invulnérable 2s toutes les 6s
    desc: 'Invulnérable toutes les 6s pendant 2s.',
  },
  shaman: {
    name: 'Chaman', short: 'SHA', color: '#88FF44',
    baseHp: 50, baseDamage: 6, baseSpeed: 1.0, radius: 15,
    xpValue: 20, scoreValue: 40,
    behavior: 'chase',
    special: { buffNearby: true, buffRadius: 80, buffInterval: 5 }, // buff ATQ/SPD des proches toutes les 5s
    desc: 'Augmente vitesse et dégâts des ennemis proches toutes les 5s.',
  },
  // --- Bosses ---
  boss_rift: {
